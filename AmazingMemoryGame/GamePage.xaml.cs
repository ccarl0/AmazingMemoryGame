...
public partial class GamePage : ContentPage
{
    ...
    List<string> IDs_list = new List<string> { "hundred_fish.png", "dice_hand.png", "dotnet_bot.png", "k_skin.png", "e", "f", "g", "h", "hundred_fish.png", "dice_hand.png", "dotnet_bot.png", "k_skin.png", "e", "f", "g", "h"}.OrderBy(a => Guid.NewGuid()).ToList();
